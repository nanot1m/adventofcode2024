...
})({"dAga2":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "168b3dc949533a3f";
"use strict";
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "enableTrackPredecessors", ()=>enableTrackPredecessors);
parcelHelpers.export(exports, "disableTrackPredecessors", ()=>disableTrackPredecessors);
/**
 * @template T
 *
...
var _priorityQueueJs = require("./priority-queue.js");
let trackPredecessors = false;
function enableTrackPredecessors() {
    trackPredecessors = true;
}
function disableTrackPredecessors() {
    trackPredecessors = false;
}
        ...
        for (const next of getNext(current.value, current))if (valToHash) {
            ...
            if (!visited.has(hash)) {
                const item = {
                    ...
                    value: next,
                    parent: current,
                    predecessors: trackPredecessors ? [
                        current
                    ] : []
                };
                visited.set(hash, item);
                queue.push(item);
            } else if (trackPredecessors) {
                const item = visited.get(hash);
                if (item.distance === current.distance + getDistance(next)) item.predecessors.push(current);
            }
        } else queue.push({
            distance: current.distance + getDistance(next),
            value: next,
...
},{"./index.js":"Zicik","./lib.js":"evqQV","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eJ4CG":[function(require,module,exports,__globalThis) {
// @ts-check
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["dAga2"], null, "parcelRequire94c2")

//# sourceMappingURL=index.49533a3f.js.map
