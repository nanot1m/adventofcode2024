 ...
 */ function draw(input, ctx) {
    ...
    const refreshRobotDisplay = function() {
        ...
        const newRobots = robots.map((robot)=>({
                pos: (0, _14Js.calc)(robot.pos, robot.vel, t),
                vel: robot.vel
            }));
    ...
    raf = requestAnimationFrame(function render() {
        ...
        for(let i = 0; i < 10; i++){
            ...
            newRobots = robots.map((robot)=>({
                    pos: (0, _14Js.calc)(robot.pos, robot.vel, time),
                    vel: robot.vel
                }));
...
},{"../../../js/modules/iterator-extensions.js":"8eMUF","../../../js/solutions/14.js":"gNXSX","../../../js/modules/index.js":"Zicik","../common.js":"8wzUn"}],"gNXSX":[function(require,module,exports,__globalThis) {
// @ts-check
...
},{"../modules/index.js":"Zicik","../modules/itertools.js":"hlPOX","../modules/parser.js":"eJ4CG","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eJ4CG":[function(require,module,exports,__globalThis) {
// @ts-check
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./index.js":"Zicik","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["fmZhM","aZTvN"], "aZTvN", "parcelRequire94c2")
