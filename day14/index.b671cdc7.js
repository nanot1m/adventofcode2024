...
})({"k3LKg":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "141996aab671cdc7";
"use strict";
...
parcelHelpers.export(exports, "asciiBlue", ()=>asciiBlue);
parcelHelpers.export(exports, "asciiGreen", ()=>asciiGreen);
parcelHelpers.export(exports, "asciiRed", ()=>asciiRed);
parcelHelpers.export(exports, "asciiYellow", ()=>asciiYellow);
parcelHelpers.export(exports, "asciiMagenta", ()=>asciiMagenta);
parcelHelpers.export(exports, "asciiCyan", ()=>asciiCyan);
...
const asciiYellow = (/** @type {string} */ str)=>`\x1b[33m${str}\x1b[0m`;
const asciiMagenta = (/** @type {string} */ str)=>`\x1b[35m${str}\x1b[0m`;
const asciiCyan = (/** @type {string} */ str)=>`\x1b[36m${str}\x1b[0m`;
...
function* dijkstra(getNext, starts, valToHash) {
    ...
    for (const { value, distance } of starts){
        ...
        queue.push(item);
        if (valToHash) visited.set(valToHash(value), item);
    }
    while(queue.length){
        const current = queue.pop();
        yield current;
        for (const { value, distance: d } of getNext(current.value, current)){
            ...
            if (valToHash) {
                ...
                if (visited.has(hash)) {
                    ...
                    } else if (distance === item.distance) item.predecessors.push(current);
                } else {
                    /** @type {PathItem<T>} */ const item = {
                        distance: distance,
                        value: value,
...
},{"./index.js":"6dHdC","./lib.js":"bDK29","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8wzUn":[function(require,module,exports,__globalThis) {
// @ts-check
/**
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["k3LKg"], null, "parcelRequire94c2")

//# sourceMappingURL=index.b671cdc7.js.map
